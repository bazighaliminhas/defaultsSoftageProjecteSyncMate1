...
namespace EdiEngine.Standards.X12_004010VICS.Maps
{
	public class M_195 : MapLoop
	{
		...
		public class L_N1 : MapLoop
		{
			public L_N1(MapLoop parentLoop) : base(parentLoop)
			{
				Content.AddRange(new MapBaseEntity[] {
					...
					new L_CRC_1(this) { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },
		...
		//3200
		public class L_CRC_1 : MapLoop
		{
			public L_CRC_1(MapLoop parentLoop) : base(parentLoop)
			{
				Content.AddRange(new MapBaseEntity[] {
					new CRC() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
		...
		public class L_PO1 : MapLoop
		{
			public L_PO1(MapLoop parentLoop) : base(parentLoop)
			{
				Content.AddRange(new MapBaseEntity[] {
					...
					new L_CRC_2(this) { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },
				});
			}
		}
		...
		public class L_MEA : MapLoop
		{
			public L_MEA(MapLoop parentLoop) : base(parentLoop)
			{
				Content.AddRange(new MapBaseEntity[] {
					...
					new LIE() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },
				});
			}
		}
		...
		//4500
		public class L_CRC_2 : MapLoop
		{
			public L_CRC_2(MapLoop parentLoop) : base(parentLoop)
			{
				Content.AddRange(new MapBaseEntity[] {
					new CRC() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
					new REF() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },

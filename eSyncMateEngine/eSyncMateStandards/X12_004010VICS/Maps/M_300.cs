...
{
	public class M_300 : MapLoop
	{
		public M_300() : base(null)
		{
			Content.AddRange(new MapBaseEntity[] {
				...
				new Y1() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
				new L_Y2(this) { ReqDes = RequirementDesignator.Optional, MaxOccurs = 10 },
		...
		//1000
		public class L_Y2 : MapLoop
		{
			public L_Y2(MapLoop parentLoop) : base(parentLoop)
			{
				Content.AddRange(new MapBaseEntity[] {
					new Y2() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
					new W09() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 1 },
				});
			}
		}

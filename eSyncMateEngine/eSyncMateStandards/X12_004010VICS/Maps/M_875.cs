...
{
	public class M_875 : MapLoop
	{
		public M_875() : base(null)
		{
			Content.AddRange(new MapBaseEntity[] {
				new G50() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
				...
				new L_G68(this) { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 9999 },
				new G76() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
			});
		}

...
{
	public class M_836 : MapLoop
	{
		public M_836() : base(null)
		{
			Content.AddRange(new MapBaseEntity[] {
				new BCO() { ReqDes = RequirementDesignator.Mandatory, MaxOccurs = 1 },
		...
		public class L_PO1 : MapLoop
		{
			public L_PO1(MapLoop parentLoop) : base(parentLoop)
			{
				Content.AddRange(new MapBaseEntity[] {
					...
					new PO3() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },
					...
					new CTB() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 1 },
					new QTY() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },
					new AMT() { ReqDes = RequirementDesignator.Optional, MaxOccurs = 999999 },

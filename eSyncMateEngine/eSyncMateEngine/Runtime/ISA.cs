    ...
    public class ISA : EdiSegment
    {
            ...
            ) : base(definition)
        {
            Content.AddRange(new[] {
                ...
                new EdiSimpleDataElement((MapSimpleDataElement)definition.Content[10], ISA11_RepeatCharacter),
                ...
                new EdiSimpleDataElement((MapSimpleDataElement)definition.Content[15], string.IsNullOrEmpty(ISA16_SubElemnetSeperator) ? EdiInterchange.DefaultCompositeSeparator : ISA16_SubElemnetSeperator)
            });
        }
    }
}

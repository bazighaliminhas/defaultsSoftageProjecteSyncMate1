        ...
        protected virtual StringBuilder WriteToStringBuilder(EdiBatch batch)
        {
            ...
            foreach (EdiInterchange ich in batch.Interchanges)
            {
                ich.ISA = new ISA(_settings.IsaDef,
                    ...
                    _settings.IsaReceiverQual, _settings.IsaReceiverId, _settings.RepeatCharacter,
                    _settings.IsaEdiVersion, icn, _settings.IsaUsageIndicator, _settings.SubElementSeparator);

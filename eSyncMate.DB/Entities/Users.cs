...
{
    public class Users : DBEntity, IDBEntity, IDisposable, IEqualityComparer
    {
        ...
        /// TODO: Update summary.
        /// </summary>
        public Users(DBConnector p_Connection) : base(p_Connection)
        {
            SetupDBEntity();
        }
        ...
        /// TODO: Update summary.
        /// </summary>
        public Users(string p_ConnectionString) : base(p_ConnectionString)
        {
            SetupDBEntity();
        }
        ...
        private void SetupDBEntity()
        {
            ...
            if (string.IsNullOrEmpty(Users.ViewName))
            {
                Users.ViewName = "VW_Users";
            }

            if (string.IsNullOrEmpty(Users.PrimaryKeyName))
            {
                Users.PrimaryKeyName = "Id";
            }

            if (string.IsNullOrEmpty(Users.EndingPropertyName))
            {
                Users.EndingPropertyName = "CreatedBy";
            }
            ...
            {
                Users.InsertQueryStart = PrepareQueries(this, Users.TableName, Users.EndingPropertyName, ref l_Query, Users.DBProperties);
            }
        }
        ...
        public bool GetList(string p_Criteria, string p_Fields, ref DataTable p_Data, string p_OrderBy = "")
        {
            ...
            {
                l_Query = "SELECT * FROM [" + Users.TableName + "]";
            }
            else
            {
                l_Query = "SELECT " + p_Fields + " FROM [" + Users.TableName + "]";
            }
        ...
        public bool GetViewList(string p_Criteria, string p_Fields, ref DataTable p_Data, string p_OrderBy = "")
        {
            ...
            if (string.IsNullOrEmpty(p_Fields))
            {
                l_Query = "SELECT * FROM [" + Users.ViewName + "]";
            }
            else
            {
                l_Query = "SELECT " + p_Fields + " FROM [" + Users.ViewName + "]";
            }
        ...
        {
            SetProperty(Users.PrimaryKeyName, p_PrimaryKey);
            return GetObjectFromQuery(PrepareGetObjectQuery(this, Users.ViewName, Users.PrimaryKeyName));
        }
        ...
        public int GetMax()
        {
            ...
            if (!l_Common.GetList("SELECT MAX(CONVERT(INT, ISNULL(" + Users.PrimaryKeyName + ", '0'))) FROM " + Users.TableName, ref l_Data))
            {
                return l_MaxNo;
            }
        ...
        {
            return GetObjectFromQuery(PrepareGetObjectQuery(this, Users.ViewName, Users.PrimaryKeyName), true);
        }
        ...
        public Result GetObject(string propertyName, object propertyValue)
        {
            ...
            return GetObjectFromQuery(PrepareGetObjectQuery(this, Users.ViewName, propertyName));
        }
        ...
        public Result SaveNew()
        {
            ...
            try
            {
                ...
                l_Query = this.PrepareInsertQuery(this, Users.InsertQueryStart, Users.EndingPropertyName, Users.DBProperties);
        ...
        public Result Modify()
        {
            ...
            try
            {
                ...
                l_Query = this.PrepareUpdateQuery(this, Users.TableName, Users.PrimaryKeyName, Users.EndingPropertyName, Users.DBProperties);
        ...
        public string Encrypt(string strInput)
        {
            ...
            for (long iCount = 0; iCount < strInput.Length; iCount++)
            {
                if (strInput.Substring(0, (int)iCount) != strKey)
                {
                    input[iCount] = (char)(input[iCount] ^ strKey[(int)lngPtr]);
                    lngPtr = (lngPtr + 1) % strKey.Length;
                }
            }

            strInput = new string(input);
            return strInput;
        }
        ...
        public Result Delete()
        {
            ...
            try
            {
                ...
                l_Query = this.PrepareDeleteQuery(this, Users.TableName, Users.PrimaryKeyName);

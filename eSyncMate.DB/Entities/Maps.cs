...
{
    public class Maps : DBEntity, IDBEntity, IDisposable, IEqualityComparer
    {
        ...
        /// TODO: Update summary.
        /// </summary>
        public Maps(DBConnector p_Connection) : base(p_Connection)
        {
            SetupDBEntity();
        }
        ...
        /// TODO: Update summary.
        /// </summary>
        public Maps(string p_ConnectionString) : base(p_ConnectionString)
        {
            SetupDBEntity();
        }
        ...
        private void SetupDBEntity()
        {
            ...
            if (string.IsNullOrEmpty(Maps.TableName))
            {
                Maps.TableName = "Maps";
            }

            if (string.IsNullOrEmpty(Maps.ViewName))
            {
                Maps.ViewName = "VW_Maps";
            }

            if (string.IsNullOrEmpty(Maps.PrimaryKeyName))
            {
                Maps.PrimaryKeyName = "Id";
            }

            if (string.IsNullOrEmpty(Maps.EndingPropertyName))
            {
                Maps.EndingPropertyName = "CreatedBy";
            }

            if (Maps.DBProperties == null)
            {
                Maps.DBProperties = new List<PropertyInfo>(this.GetType().GetProperties());
            }

            if (string.IsNullOrEmpty(Maps.InsertQueryStart))
            {
                Maps.InsertQueryStart = PrepareQueries(this, Maps.TableName, Maps.EndingPropertyName, ref l_Query, Maps.DBProperties);
            }
        }
        ...
        public bool GetList(string p_Criteria, string p_Fields, ref DataTable p_Data, string p_OrderBy = "")
        {
            ...
            {
                l_Query = "SELECT * FROM [" + Maps.TableName + "]";
            }
            else
            {
                l_Query = "SELECT " + p_Fields + " FROM [" + Maps.TableName + "]";
            }
        ...
        public bool GetViewList(string p_Criteria, string p_Fields, ref DataTable p_Data, string p_OrderBy = "")
        {
            ...
            if (string.IsNullOrEmpty(p_Fields))
            {
                l_Query = "SELECT * FROM [" + Maps.ViewName + "]";
            }
            else
            {
                l_Query = "SELECT " + p_Fields + " FROM [" + Maps.ViewName + "]";
            }
        ...
        {
            SetProperty(Maps.PrimaryKeyName, p_PrimaryKey);
            return GetObjectFromQuery(PrepareGetObjectQuery(this, Maps.ViewName, Maps.PrimaryKeyName));
        }
        ...
        public int GetMax()
        {
            ...
            if (!l_Common.GetList("SELECT MAX(CONVERT(INT, ISNULL(" + Maps.PrimaryKeyName + ", '0'))) FROM " + Maps.TableName, ref l_Data))
            {
                return l_MaxNo;
            }
        ...
        {
            return GetObjectFromQuery(PrepareGetObjectQuery(this, Maps.ViewName, Maps.PrimaryKeyName), true);
        }
        ...
        public Result GetObject(string propertyName, object propertyValue)
        {
            ...
            return GetObjectFromQuery(PrepareGetObjectQuery(this, Maps.ViewName, propertyName));
        }
        ...
        public Result SaveNew()
        {
            ...
            try
            {
                ...
                l_Query = this.PrepareInsertQuery(this, Maps.InsertQueryStart, Maps.EndingPropertyName, Maps.DBProperties);
        ...
        public Result Modify()
        {
            ...
            try
            {
                ...
                l_Query = this.PrepareUpdateQuery(this, Maps.TableName, Maps.PrimaryKeyName, Maps.EndingPropertyName, Maps.DBProperties);
        ...
        public Result Delete()
        {
            ...
            try
            {
                ...
                l_Query = this.PrepareDeleteQuery(this, Maps.TableName, Maps.PrimaryKeyName);
